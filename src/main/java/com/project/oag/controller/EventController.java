...
public class EventController {
	 ...
	 * 
	 * @PostMapping
	 *              public ResponseEntity<EventDto> registerEvent(@RequestBody
	 *              EventDto eventDto) {
	 *              try {
	 ...
	 * 
	 *              @PutMapping("/{eventId}")
	 *              public ResponseEntity<Event> update(@PathVariable Long
	 *              eventId, @Valid Event event,
	 * @RequestParam(name = "photo", required = false) MultipartFile photo) throws
	 *                    IOException {
	 *                    event.setId(eventId);
	...
	/**
	 * @PutMapping("/{eventId}")
	 * public ResponseEntity<EventDto> updateEvent(@PathVariable Long
	 * eventId, @RequestBody @Valid EventDto eventDto) {
