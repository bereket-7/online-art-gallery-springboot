...
//        logger.error("400 PaymentStatus Code", ex);
...
//        logger.error("404 PaymentStatus Code", ex);
...
//        logger.error("409 PaymentStatus Code", ex);
...
//        logger.error("500 PaymentStatus Code", ex);
